...
void main() {
	...
	printf("¬ведите координаты и радиус первой окружности: ");
	scanf_s("%f %f %f", &x1, &y1, &r1);
	printf("¬ведите координаты и радиус второй окружности: ");
	scanf_s("%f %f %f", &x2, &y2, &r2);
	// касаютс€ внутри, касаютс€ снаружи, совпадают, не касаютс€, пересекаютс€
	double rasst = sqrt((x2 - x1) * (x2 - x1) + (y2 - y1) * (y2 - y1));
	if (x1 == x2 && y1 == y2 && r1 == r2) {
		printf("ќкружности совпадают. ");
	}
	else if (rasst > (r1 + r2)) { // не касаютс€
		printf("ќкружности не касаютс€ и не пересекаютс€, никака€ из окружностей не находитс€ внутри другой. ");
	}
	else if (rasst == (r1 + r2)) {
		printf("ќкружности касаютс€ снаружи. ");
	}
	else if (rasst == fabs(r1 - r2)) {
		printf("ќкружности касаютс€ внутри. ");
	}
	else if (x1 == x2 && y1 == y2 && r1 != r2) {
		printf("÷ентры окружностей совпадают, радиусы не совпадают. ");
	}

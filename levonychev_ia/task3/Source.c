...
void main()
{
    ...
    do
    {   
        printf("\n\n\nВыберите n от 2 до 5. Введите 0, если хотите выйти.\n");
        do
        {
            scanf("%d", &n);
            if (!(n == 0 || (n >= 2 && n <= 5)))
...
void game(int n)
{
    ...
    // Генерация числа
    if (n == 2)
        printf("\n--------------------\nВы выбрали режим с двузначным числом.\n");
    if (n == 3)
        printf("\n--------------------\nВы выбрали режим с трехзначным числом.\n");
    if (n == 4)
        printf("\n--------------------\nВы выбрали режим с четырехзначным числом.\n");
    if (n == 5)
        printf("\n--------------------\nВы выбрали режим с пятизначным числом.\n");
